...
router.get('/users/:id', validations.authenticate, validations.checkUser, user.getUser)
router.patch('/users/:id', validations.authenticate, validations.checkUser, user.updateUserRole)
